...
class HandleBrowserRequestsClass(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    def start_audit(self, args):
        ...
        if not dercert in certs_and_enc_pms:
            ...
            print ("Set pms secret to: ", binascii.hexlify(pms_secret))
            print ("Set pms padding secret to: ", binascii.hexlify(pms_padding_secret))
        ...
        print ("About to start handshake with this encpms: ", tlsn_session.enc_pms)
...
def verify_server(claimed_cert, tlsn_session):
    ...
    #print ('working with our cert: \n', binascii.hexlify(tlsn_session.server_certificate.asn1cert))
    #print ('and claimed cert: \n', binascii.hexlify(claimed_cert))
